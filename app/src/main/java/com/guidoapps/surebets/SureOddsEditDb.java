...
public class SureOddsEditDb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sure_odds_populatedb);
...
//views
    ...
    private void updatedB(){
        DocumentReference updateref = db.collection("sureodds").document(id);
