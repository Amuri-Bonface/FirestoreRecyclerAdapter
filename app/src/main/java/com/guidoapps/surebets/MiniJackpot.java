...
public class MiniJackpot extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mini_jackpot);
        ...
        newdoc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MiniJackpot.this, MiniJackpotEditDb.class));
            }
        });
    ...
    private void getFriendList(){
        Query query = db.collection("minijackpot");
               ...
               /* Glide.with(getApplicationContext())
                ...
                holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        db.collection("minijackpot").document(docId)
                                .delete()
                ...
                holder.itemView.setOnClickListener(v -> {
                    ...
                    Intent intent= new Intent(MiniJackpot.this ,MiniJackpotEditDb.class);
