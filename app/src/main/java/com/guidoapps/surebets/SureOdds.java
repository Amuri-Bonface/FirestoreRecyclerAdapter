...
public class SureOdds extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sure_odds);
        ...
        newdoc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SureOdds.this, SureOddsEditDb.class));
            }
        });
    ...
    private void getFriendList(){
        Query query = db.collection("sureodds");
            ...
            public void onBindViewHolder(FriendsHolder holder, int position, PredictionModel model) {
               ...
               /* Glide.with(getApplicationContext())
                ...
                holder.itemView.setOnLongClickListener(v -> {
                    db.collection("sureodds").document(docId)
                            .delete()
                ...
                holder.itemView.setOnClickListener(v -> {
                    ...
                    Intent intent= new Intent(SureOdds.this ,SureOddsEditDb.class);
