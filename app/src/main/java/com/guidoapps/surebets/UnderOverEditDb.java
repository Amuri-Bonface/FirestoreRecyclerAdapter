...
public class UnderOverEditDb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.unde_over_populatedb);
...
//views
    ...
    private void updatedB(){
        DocumentReference updateref = db.collection("underover").document(id);
