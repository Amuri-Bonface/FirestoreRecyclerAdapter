...
public class DoubleChanceEditDb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.double_chance_populatedb);
...
//views
    ...
    private void updatedB(){
        DocumentReference updateref = db.collection("doublechance").document(id);
