...
public class UndeOver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newdoc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UndeOver.this, UnderOverEditDb.class));
            }
        });
    ...
    private void getFriendList(){
        Query query = db.collection("underover");
               ...
               /* Glide.with(getApplicationContext())
                ...
                holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        db.collection("underover").document(docId)
                                .delete()
                ...
                holder.itemView.setOnClickListener(v -> {
                    ...
                    Intent intent= new Intent(UndeOver.this ,UnderOverEditDb.class);
