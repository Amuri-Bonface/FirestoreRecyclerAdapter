...
public class DoubleChance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.double_chance);
        ...
        newdoc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DoubleChance.this, DoubleChanceEditDb.class));
            }
        });
    ...
    private void getFriendList(){
        Query query = db.collection("doublechance");
        ...
        adapter = new FirestoreRecyclerAdapter<PredictionModel, FriendsHolder>(response) {
            ...
            public void onBindViewHolder(FriendsHolder holder, int position, PredictionModel model) {
                ...
                }catch (Exception ex){Toast.makeText(DoubleChance.this,"Msg"+ex,Toast.LENGTH_LONG).show();}
               ...
               holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                   ...
                   public boolean onLongClick(View v) {
                       db.collection("doublechance").document(docId)
                               .delete()
                ...
                holder.itemView.setOnClickListener(v -> {
                                ...
                                Intent intent= new Intent(DoubleChance.this ,DoubleChanceEditDb.class);
