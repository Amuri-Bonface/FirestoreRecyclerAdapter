...
public class LiveInPlayEditDb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.live_inplay_populatedb);
...
//views
    ...
    private void updatedB(){
        DocumentReference updateref = db.collection("liveinplay").document(id);
