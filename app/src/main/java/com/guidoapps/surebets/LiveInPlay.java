...
public class LiveInPlay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newdoc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(LiveInPlay.this, LiveInPlayEditDb.class));
            }
        });
    ...
    private void getFriendList(){
        Query query = db.collection("liveinplay");
               ...
               /* Glide.with(getApplicationContext())
                ...
                holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        db.collection("liveinplay").document(docId)
                                .delete()
                ...
                holder.itemView.setOnClickListener(v -> {
                    ...
                    Intent intent= new Intent(LiveInPlay.this ,LiveInPlayEditDb.class);
