...
public class MiniJackpotEditDb extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mini_jackpot_populatedb);
...
//views
    ...
    private void updatedB(){
        DocumentReference updateref = db.collection("minijackpot").document(id);
